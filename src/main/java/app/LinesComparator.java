...
public class LinesComparator implements Comparator<List<String>> {
    ...
    public int compare(List<String> o1, List<String> o2) {
        for (int i = 0; i < Math.min(o1.size(), o2.size()); i++) {
            ...
            if (isNumeric(s1) && isNumeric(s2)) difference = Double.compare(Double.parseDouble(s1), Double.parseDouble(s2));
     ...
     *
     * @param  str – string assumes as number(integer or double).
